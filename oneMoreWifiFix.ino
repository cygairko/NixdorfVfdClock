#include <RTClib.h>
#include "libraries\NixdorfVfdLib\src\NixdorfVFD.h"   // https://github.com/MrTransistorsChannel/NixdorfVFD
...
void showVfdText(int textTimeout, String text) {
  vfd.clear();
  vfd.home();
  vfd.setCursor(0, 0);
  vfd.print(text);
